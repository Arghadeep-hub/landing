            ...
            <div className="container-fluid text-center text-md-left">
                ...
                <div className="row text-center text-md-left">
                    ...
                    <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                        <h5 className="text-uppercase mb-4 font-weight-bold" style={{ color: "#ddd" }}>Important Links</h5>
                        ...
                        <p><Link to="/" className="text-white" style={{ textDecoration: "none" }} title="Entrance Exam Website">Examination Portal</Link></p>
                        <p><Link to="/" className="text-white" style={{ textDecoration: "none" }} title="Compititive Programming Community"> Hack with REPL</Link></p>
                    </div>
